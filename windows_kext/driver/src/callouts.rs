...
pub fn get_callout_vec() -> Vec<Callout> {
    alloc::vec![
        ...
        Callout::new(
            ...
            "Portmaster uses this layer for split-tunneling of outbound connections (IPv4)",
        ...
        Callout::new(
            ...
            "Portmaster uses this layer for split-tunneling of outbound connections (IPv6)",
